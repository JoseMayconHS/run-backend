...
module.exports = {
	...
	update(table = String, settings = Object, where = Object) {
		return new Promise(resolve => {
			...
			`, [], err => {
				...
				resolve({ status: true, massage: 'Sucesso!!!'})
			})
		})
	},
	insert(table = String, fields = String, values = Array) {
		return new Promise(resolve => {
	...
	remove(table = String, settings = Object) {
		return new Promise(resolve => {
